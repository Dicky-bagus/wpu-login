		...
		<div class="col-lg-6">
			...
			<form action="<?= base_url('user/changepassword'); ?>" method="POST">
				<div class="form-group">
					...
					<?= form_error('current_password', '<div class="text-danger pl-3">', '</div>'); ?>
				</div>
				<div class="form-group">
					<label for="new_password1">New Password</label>
					<input type="password" name="new_password1" id="new_password1" class="form-control">
					<?= form_error('new_password1', '<div class="text-danger pl-3">', '</div>'); ?>
				</div>
				<div class="form-group">
					<label for="new_password2">Repeat Password</label>
					<input type="password" name="new_password2" id="new_password2" class="form-control">
					<?= form_error('new_password2', '<div class="text-danger pl-3">', '</div>'); ?>
				</div>
				<div class="form-group">
